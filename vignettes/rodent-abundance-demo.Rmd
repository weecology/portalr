...
rodent_data %>%
  ...
  join_scientific_name() %>%
  make_abundance_plot_over_time() %>%
  {.} -> rodent_abundance_in_exclosures_plot

print(rodent_abundance_in_exclosures_plot)
```

Since this has the same number of plots as the previous figure, we can directly compare abundances. Note the decreased numbers for kangaroo rats (*Dipodomys spp.*) and increased numbers for some other taxa.

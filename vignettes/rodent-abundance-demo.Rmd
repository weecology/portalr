...
```{r}
my_path <- tempdir() # use a temporary folder to store downloaded data
...
```{r}
rodent_abundance <- abundance(path = my_path, time = "date") %>%
...
abundance(path = my_path, time = "date", level = "plot") %>%

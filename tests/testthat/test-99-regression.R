...
test_that("data generated by default setting is same (plants)", {
  ...
  attributes(data) <- attributes(data)[sort(names(attributes(data)))]
  expect_known_hash(data$year, "fc4f048612")
  expect_known_hash(data.frame(year = data$year), "f4a6a8c9d8")
  expect_known_hash(tibble::tibble(year = data$year), "f0a0c66e69")
  expect_known_hash(data["year"], "f0a0c66e69")
  expect_known_hash(str(data), "f9e884084b")
  expect_known_hash(data[c("year", "season", "species", "abundance", "quads")], "7911c72f15")

...
test_that("summarize_individual_rodents returns expected columns", {
  ...
  expect_equal(names(stake_data), c("period","month","day","year","treatment","plot","stake","species",
  ...
  expect_equal(names(filled_stake_data), c("newmoonnumber","month","day","year","treatment","plot","stake",

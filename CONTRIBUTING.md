...
check out the [readme](https://weecology.github.io/portalr/README.md)
for general info about this project.

## Contributor Code of Conduct

All contributors will be expected to follow our [code of
conduct](https://weecology.github.io/portalr/CODE_OF_CONDUCT.md).
...
2.  Fork and create a pull request – if you have suggested bugfixes or
    changes. For more info, please check out this Github
...
documentation](http://r-pkgs.had.co.nz/man.md) in Hadley Wickham’s book
for R packages.
...
[chapter on testing](http://r-pkgs.had.co.nz/tests.md) in Hadley
...
For more info, see the [GitHub repo](https://github.com/r-lib/devtools)

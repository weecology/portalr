...
#' @param type specify subset of species; either "All" - includes annuals, perennials, and shrubs;
#'   "Annuals" - only annuals; or "Non-woody" - includes annuals and perennials, not shrubs
